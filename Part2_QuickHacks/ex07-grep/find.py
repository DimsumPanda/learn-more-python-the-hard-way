...
if __name__ == "__main__":
    ...
    # files_list = os.listdir(args.dirpath)
    ...
    for file in files_list:
        ...
        # If the args.name match
        # if ((not args.name or fnmatch.fnmatch(file, args.name))
        #     and (not args.type or (args.type == "d" and os.path.isdir(file)))):
